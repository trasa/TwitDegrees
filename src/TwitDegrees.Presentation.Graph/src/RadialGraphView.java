...
import TwitDegrees.Presentation.TwitterClient;
 ...
 * 
 * Hacked up into pieces for displaying TwitDegrees stuff
 * - Tony Rasa trasa@blackfin.com
 */
public class RadialGraphView extends Display {

    //public static final String DATA_FILE = "C:\\Projects\\meancat\\misc\\TwitDegrees\\trunk\\src\\TwitDegrees.Presentation.Graph\\src\\trasa.xml";
...
//    }
    ...
    public static JPanel demo(final String label) {
        ...
        Graph g = null;
        try {
            String xml = client.getUserGraphML("trasa");
            // convert to stream
            g = new GraphMLReader().readGraph(new ByteArrayInputStream(xml.getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
        }
